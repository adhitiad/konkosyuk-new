...
const sections: { title: string; links: FooterLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      { label: 'Cari Kos', href: '#kategori' },
      { label: 'Kota Populer', href: '#kota' },
      { label: 'Kos Rekomendasi', href: '#rekomendasi' },
      { label: 'Aplikasi Mobile', href: '#app' },
    ],
  },
  {
    title: 'Untuk Pemilik Kos',
    links: [
      { label: 'Pasang Iklan', href: '#pemilik' },
      { label: 'Manajemen Kamar', href: '#manajemen' },
      { label: 'Verifikasi Properti', href: '#verifikasi' },
      { label: 'Bantuan Owner', href: '#bantuan-owner' },
    ],
  },
  {
    title: 'Bantuan',
